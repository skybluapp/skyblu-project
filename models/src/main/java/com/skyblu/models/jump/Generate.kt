...
val latList: List<Double> = listOf(
    52.89820,
    52.90296,
    52.91208,
    52.91974,
...
val lngList: List<Double> = listOf(
    -0.90800,
    -0.90010,
    -0.89255,
    -0.89598,
...
val pressureList: List<Float> = listOf<Float>(
    1014f,
    1001f,
    989f,
    977f,
...
fun generateSampleTrackingData(): JumpTrackingData {
    val walkingTrackingPoints: MutableList<SkydiveDataPoint> = mutableListOf()
    val aircraftTrackingPoints: MutableList<SkydiveDataPoint> = mutableListOf()
    val freefallTrackingPoints: MutableList<SkydiveDataPoint> = mutableListOf()
    val canopyTrackingPoints: MutableList<SkydiveDataPoint> = mutableListOf()
    val landedTrackingPoints: MutableList<SkydiveDataPoint> = mutableListOf()
    ...
    for (i in lngList.indices) {
        ...
        val trackingPoint = SkydiveDataPoint(
            dataPointID = "5",
            latitude = latList[i],
            longitude = lngList[i],
            airPressure = pressureList[i],
            altitude = pressureList[i].hpaToFeet(),
    ...
    return JumpTrackingData(
        jumpId = UUID.randomUUID().toString(),
        walkingTrackingPoints = walkingTrackingPoints,
